...
def set_active_music_preset(preset_id: Optional[str]) -> None:
    _music_preset_id.set((preset_id or "").strip())


def get_active_music_preset() -> str:
    return _music_preset_id.get() or ""
