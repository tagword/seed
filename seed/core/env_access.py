...
TRANSCRIPT: Tuple[str, ...] = ('SEED_TRANSCRIPT',)
...
CONTEXT_COMPACT_MIN_BYTES: Tuple[str, ...] = ('SEED_CONTEXT_COMPACT_MIN_BYTES',)
CONTEXT_COMPACT_MIN_ROUNDS: Tuple[str, ...] = ('SEED_CONTEXT_COMPACT_MIN_ROUNDS',)
