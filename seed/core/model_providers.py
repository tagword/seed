...
Speech (T2A) — MiniMax only today:
  ...
  - MiniMax chat preset api_key is shared for chat, image, speech, and music endpoints
"""
...
PROVIDER_CATALOG: List[Dict[str, Any]] = [
    ...
    },
    {
        "id": "minimax",
        "label": "MiniMax",
        "description": "MiniMax 开放平台；聊天、生图、朗读（T2A）、音乐生成共用 API Key",
        ...
        "capabilities": ["chat", "image", "speech", "music"],
        "requires_api_key": True,
        "models": {
            "chat": [
                {"id": "MiniMax-M2.7", "label": "MiniMax-M2.7"},
